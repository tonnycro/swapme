...
export default function Footer() {
  return (
    <div className='border-t border-gray-800 mt-5 flex  gap-6 justify-between items-center  md:gap-0 p-5 relative z-20'>
       ...
       <div className="flex justify-end items-center gap-5">
          {/* tg */}
          <a href="https://t.me/pegasus_sonic">
          ...
          {/* twitter */}
          <a href="http://x.com/Pegasus_Sonic">
